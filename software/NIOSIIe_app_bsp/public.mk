...
SOPCINFO_FILE := E:/quartus/projects/NES/qsys/NIOSIIe.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x220
SOPC_SYSID_FLAG += --sidp=0x220
ELF_PATCH_FLAG  += --sidp 0x220

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1639120334
SOPC_SYSID_FLAG += --timestamp=1639120334
ELF_PATCH_FLAG  += --timestamp 1639120334
